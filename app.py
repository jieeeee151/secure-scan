...
def download_report():
    ...
    # 🎨 RESULT COLOR
    if "Strong" in result or "Safe" in result:
        color = "green"
    elif "Medium" in result:
        color = "orange"
    else:
    ...
    # 🔥 MAIN INFO
    content.append(Paragraph(f"<b>Tool Used:</b> {tool}", styles['Normal']))
    ...
    content.append(
        Paragraph(f"<b>Result:</b> <font color='{color}'>{result}</font>", styles['Normal'])
    )
    ...
    content.append(
        Paragraph(
            "<font size=9 color='grey'>Generated by SecureScan | Cybersecurity Toolkit</font>",
            styles['Normal']
        )
    )
...
def download_history():
    ...
    # 🔥 TITLE
    title = Paragraph("<b>SecureScan Full History Report</b>", styles['Title'])
    ...
    for scan in scans:
        ...
        text = f"""
        <b>Tool:</b> {tool}<br/>
        <b>Result:</b> <font color="{color}">{result}</font><br/>
        <b>Time:</b> {time}
        """
        ...
        # 🔥 divider line
        elements.append(Paragraph("<font color='grey'>-------------------------------------------</font>", styles['Normal']))
        elements.append(Spacer(1, 15))

    # 🔥 FOOTER TEXT
    elements.append(Spacer(1, 20))
    footer = Paragraph("Generated by SecureScan | Cybersecurity Toolkit", styles['Italic'])
